defmodule Vemosla.AccountsTest do
  ...
  describe "profiles" do
    ...
    @valid_attrs %{"\" --binary-id --context-app vemosla \"": "some \" --binary-id --context-app vemosla \"", city: "some city", country: "some country", name: "some name", photo: "some photo"}
    @update_attrs %{"\" --binary-id --context-app vemosla \"": "some updated \" --binary-id --context-app vemosla \"", city: "some updated city", country: "some updated country", name: "some updated name", photo: "some updated photo"}
    @invalid_attrs %{"\" --binary-id --context-app vemosla \"": nil, city: nil, country: nil, name: nil, photo: nil}
    ...
    test "create_profile/1 with valid data creates a profile" do
      ...
      assert profile." --binary-id --context-app vemosla " == "some \" --binary-id --context-app vemosla \""
    ...
    test "update_profile/2 with valid data updates the profile" do
      ...
      assert profile." --binary-id --context-app vemosla " == "some updated \" --binary-id --context-app vemosla \""
